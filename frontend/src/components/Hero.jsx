            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl mx-auto text-center mb-16">
                    ...
                    <div className="relative w-full max-w-2xl mx-auto mb-0 mt-4 group">
                        {/* Sticker: Left of Video - Hidden on small screens, only for large desktop */}
                        <div className="hidden xl:block absolute -left-[35rem] top-[20%] -translate-y-1/2 w-[55rem] animate-float-v z-20 pointer-events-none">
                            <img src="/media/left-float-gemini.png" alt="Sticker Left" className="w-full h-auto drop-shadow-xl rotate-[-6deg]" />
                        </div>
                        {/* Sticker: Right of Video - Hidden on small screens, only for large desktop */}
                        <div className="hidden xl:block absolute -right-[35rem] top-[20%] -translate-y-1/2 w-[55rem] animate-float-v z-20 pointer-events-none">
