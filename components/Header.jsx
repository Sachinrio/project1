        ...
        <header className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ${scrolled ? 'bg-white/90 backdrop-blur-xl h-16 shadow-sm border-b border-slate-100' : 'bg-transparent h-24'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    <button className="text-sm font-black uppercase tracking-widest text-slate-500 hover:text-slate-950 transition-colors">Log In</button>
                    <button className="bg-slate-900 text-white text-[11px] font-black uppercase tracking-widest px-8 py-3.5 rounded-2xl hover:bg-indigo-600 transition-all btn-bounce shadow-xl shadow-indigo-100">
                        Join Hub
                    </button>
                </div>
            </div>
